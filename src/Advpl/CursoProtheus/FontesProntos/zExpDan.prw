...
User Function zExpDan()
	//Valida se existe o RDMAKE compilado
	If ExistBlock("DanfeProc")
		fParametros()
	Else
		FWAlertError("Não foi encontrado a função DANFEPROC no repositório! Baixe o danfeii mais atualizado no portal do cliente da TOTVS!", "Atenção")
	EndIf
Return
