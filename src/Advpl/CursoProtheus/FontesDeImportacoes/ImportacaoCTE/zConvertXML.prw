...
@author  	 Súlivan Simões (sulivan@atiliosistemas.com)
/*/
Method New(oXML) Class zConvertXML As Object 
    ::oXML := oXML
Return Self

/*/{Protheus.doc} ConvertToObject
@description Recebe o XML (em formato de texto) e monta o objeto.
             Caso não passe o XML, o método o busca pelo cArquivo
@author  	Súlivan Simões (sulivan@atiliosistemas.com)
...
@description Recebe a tag a qual se deseja obter o conteudo. 
             Esse método já traz os valores convertidos.
@author  	Súlivan Simões (sulivan@atiliosistemas.com)
...
@param 		cType, Character, tipo de informação que é esperado. Exemplo
            'C' = Caracter
            'N' = Numérico
            Usado para o conteudo já seja devolvido no tipo correto.
...
@param 		cType, Character, tipo de informação que é esperado. Exemplo
            ...
            'N' = Numérico
            Usado para o conteudo já seja devolvido no tipo correto.
@return     xAtributo, Variadic, atributo já convertido para o tipo certo
/*/ 
