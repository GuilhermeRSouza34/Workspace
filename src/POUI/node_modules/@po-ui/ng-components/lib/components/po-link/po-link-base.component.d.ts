...
export declare class PoLinkBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoLinkBaseComponent, never, never, { "label": "p-label"; "url": "p-url"; "openNewTab": "p-open-new-tab"; }, { "action": "p-action"; }, never, never, false>;
}
